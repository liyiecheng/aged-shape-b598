...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/aged-shape-b598)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/aged-shape-b598
```

A live public deployment of this template is available at [https://aged-shape-b598.templates.workers.dev](https://aged-shape-b598.templates.workers.dev)
